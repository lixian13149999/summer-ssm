...
import com.bcdbook.summer.wechat.common.util.WechatUtil;
...
import com.bcdbook.summer.wechat.pojo.message.resp.Music;
import com.bcdbook.summer.wechat.pojo.message.resp.MusicMessage;
...
public class EncapsulationService {
	 ...
	 * 
	    ...
	    * @param message
	    * @return     
	    * @see com.bcdbook.summer.wechat.service.EncapsulationService#encapsulationMsg(java.util.Map, com.bcdbook.summer.wechat.pojo.message.Message)
	 */
	 ...
	 * @param respContent
	 * @return
	 * @see com.bcdbook.summer.wechat.service.EncapsulationService#encapsulationTextMsg(java.util.Map,
	 *      java.lang.String)
	 */
...
//		musicMessage.set
	 ...
	 * 
	    ...
	    * @param reqMsg
	    * @return     
	    * @see com.bcdbook.summer.wechat.service.EncapsulationService#encapsulationDefaultMsg(java.util.Map)
	 */

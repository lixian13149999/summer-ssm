...
//import com.bcdbook.summer.wechatold.service.TemplateService;
//
////import com.bcdbook.wechat.service.impl.ConnectService;
//
//@RunWith(SpringJUnit4ClassRunner.class)		//表示继承了SpringJUnit4ClassRunner类
//@ContextConfiguration(locations = {"classpath:spring-mybatis.xml"})
//public class TestWechatOld {
//	
//	private static Logger logger = Logger.getLogger(TestWechatOld.class);
//	
//	@Resource
